...
# wb = Workbook()
filename = 'E1.1 AN IHC/Number of AN and classification accuracy'
...
filename = '../fig/E1.1 AN IHC/E1.1 Number of AN and classification accuracy.tif'
